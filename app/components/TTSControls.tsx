      ...
      {!isPlaying && (
        <>
          ...
          <div className="relative">
            ...
            {showVolumeSlider && (
              <div className="absolute top-full mt-2 left-0 z-10 bg-white dark:bg-blue-950 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 p-4 min-w-[200px]">
