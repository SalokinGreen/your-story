...
export const SYSTEM_3D6: RPGSystem = {
  ...
  aiInstructions: {
    ...
    choiceSyntax:
      "- ...Prose <use_skill: skill name (DC Number) or none; use_resource: resource name or none; use_item: item name or none; mythic_check: question (likelihood) or none; mythic_table: category or none>\nExample:\n- You carefully sneak past the sleeping dragon. <use_skill: Stealth (DC 25); use_resource: Stamina; use_item: none; mythic_check: Is the dragon asleep? (Likely); mythic_table: sounds>\n- You approach the mysterious door. <use_skill: none; use_resource: none; use_item: none; mythic_check: Is it locked? (50/50); mythic_table: none>",
    dcGuidelines:
...
export const SYSTEM_1D20: RPGSystem = {
  ...
  aiInstructions: {
    ...
    choiceSyntax:
      "- ...Prose <use_skill: skill name (DC Number) or none; use_resource: resource name or none; use_item: item name or none; mythic_check: question (likelihood) or none; mythic_table: category or none>\nExample:\n- You carefully sneak past the sleeping dragon. <use_skill: Stealth (DC 20); use_resource: Stamina; use_item: none; mythic_check: Is the dragon asleep? (Likely); mythic_table: sounds>\n- You approach the mysterious door. <use_skill: none; use_resource: none; use_item: none; mythic_check: Is it locked? (50/50); mythic_table: none>",
    dcGuidelines:
...
export const SYSTEM_1D100: RPGSystem = {
  ...
  aiInstructions: {
    ...
    choiceSyntax:
      "- ...Prose <use_skill: skill name (DC Number) or none; use_resource: resource name or none; use_item: item name or none; mythic_check: question (likelihood) or none; mythic_table: category or none>\nExample:\n- You carefully sneak past the sleeping dragon. <use_skill: Stealth (DC 100); use_resource: Stamina; use_item: none; mythic_check: Is the dragon asleep? (Likely); mythic_table: sounds>\n- You approach the mysterious door. <use_skill: none; use_resource: none; use_item: none; mythic_check: Is it locked? (50/50); mythic_table: none>",
    dcGuidelines:
...
export const SYSTEM_PERCENTILE: RPGSystem = {
  ...
  aiInstructions: {
    ...
    choiceSyntax:
      "- ...Prose <use_skill: skill name or none; use_resource: resource name or none; use_item: item name or none; mythic_check: question (likelihood) or none; mythic_table: category or none>\nPercentile Roll-Under System - No DC needed! Success = roll ≤ stat value:\nExample:\n- You carefully sneak past the sleeping dragon. <use_skill: Stealth; use_resource: none; use_item: none; mythic_check: Is the dragon asleep? (Likely); mythic_table: sounds>\n- You approach the mysterious door. <use_skill: none; use_resource: none; use_item: none; mythic_check: Is it locked? (50/50); mythic_table: none>",
    dcGuidelines:
...
"Roll Charm to persuade the guard (Charm: 65 = +1)"
  ...
  • 5: "The guard refuses and calls for backup - you hear footsteps approaching!"`,
    choiceSyntax:
      "- ...Prose <use_skill: skill name or none; use_resource: resource name or none; use_item: item name or none; mythic_check: question (likelihood) or none; mythic_table: category or none>\\nPbtA System - No DC needed! Results are: 10+ = success, 7-9 = partial success, 6- = failure:\\nExample:\\n- You carefully sneak past the sleeping dragon. <use_skill: Stealth; use_resource: none; use_item: none; mythic_check: Is the dragon asleep? (Likely); mythic_table: sounds>\\n- You try to charm the guard. <use_skill: Charisma; use_resource: none; use_item: Fancy Clothes; mythic_check: Is he in a good mood? (50/50); mythic_table: none>",
    dcGuidelines:
...
Remember: Stress creates tension, panic creates drama, pushing creates desperation. This is survival horror gaming!`,
    choiceSyntax:
      "- ...Prose <use_skill: skill name (DC Number) or none; use_resource: resource name or none; use_item: item name or none; mythic_check: question (likelihood) or none; mythic_table: category or none>\\nYZE System - DC is the number of successes needed (count 6s on d6 pool):\\nExample:\\n- You carefully sneak past the sleeping dragon. <use_skill: Stealth (DC 2); use_resource: none; use_item: none; mythic_check: Is the dragon asleep? (Likely); mythic_table: sounds>\\n- You pick the complex lock. <use_skill: Mechanics (DC 3); use_resource: none; use_item: Lockpicks; mythic_check: none; mythic_table: none>",
    dcGuidelines:
...
export const SYSTEM_EXPLOSIVE: RPGSystem = {
  ...
  aiInstructions: {
    ...
    choiceSyntax:
      "- ...Prose <use_skill: skill name (DC Number) or none; use_resource: resource name or none; use_item: item name or none; mythic_check: question (likelihood) or none; mythic_table: category or none>\nExample:\n- You carefully sneak past the sleeping dragon. <use_skill: Stealth (DC 14); use_resource: Stamina; use_item: none; mythic_check: Is the dragon asleep? (Likely); mythic_table: sounds>\n- You leap across the chasm. <use_skill: Athletics (DC 18); use_resource: none; use_item: none; mythic_check: none; mythic_table: terrain>",
    dcGuidelines:
