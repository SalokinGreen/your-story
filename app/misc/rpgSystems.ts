...
export const SYSTEM_1D20: RPGSystem = {
  ...
  aiInstructions: {
    ...
    choiceSyntax:
      "- ...Prose <use_skill: skill name (DC Number) or none; use_resource: resource name or none; use_item: item name or none; mythic_check: question (likelihood) or none; mythic_table: category or none; custom_table: table name or none>\nExample:\n- You carefully sneak past the sleeping dragon. <use_skill: Stealth (DC 20); use_resource: Stamina; use_item: none; mythic_check: Is the dragon asleep? (Likely); mythic_table: sounds; custom_table: none>\n- You approach the mysterious door. <use_skill: none; use_resource: none; use_item: none; mythic_check: Is it locked? (50/50); mythic_table: none; custom_table: none>",
    dcGuidelines:
...
Remember: Stress creates tension, panic creates drama, pushing creates desperation. This is survival horror gaming!`,
    choiceSyntax:
      "- ...Prose <use_skill: skill name (DC Number) or none; use_resource: resource name or none; use_item: item name or none; mythic_check: question (likelihood) or none; mythic_table: category or none; custom_table: table name or none>\\nYZE System - DC is the number of successes needed (count 6s on d6 pool):\\nExample:\\n- You carefully sneak past the sleeping dragon. <use_skill: Stealth (DC 2); use_resource: none; use_item: none; mythic_check: Is the dragon asleep? (Likely); mythic_table: sounds; custom_table: none>\\n- You pick the complex lock. <use_skill: Mechanics (DC 3); use_resource: none; use_item: Lockpicks; mythic_check: none; mythic_table: none; custom_table: none>",
    dcGuidelines:
