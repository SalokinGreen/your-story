...
const kids_on_machines: StoryData = {
    ...
    premise: "Kids on motorcycles explore a futuristic city filled with neon lights and towering skyscrapers.",
    player_name: "Alex",
    player_summary: "You are a daring teenager who tries to make his dead pa proud by taking over the gang.",
    starting_content: "You rev your motorcycle's engine as you and your friends speed through the neon-lit streets of Neo City. The wind rushes past you, carrying the scent of rain and electricity. Ahead, the towering skyscrapers loom like giants, their windows glowing with vibrant colors. Suddenly, a rival gang appears, blocking your path. What do you do?",
    plot_beats: [],
    memory: [],
    max_chapters: 0,
    currentChapter: 0,
    ...
    chapters: [
        {
            ...
            summary: "Eldrin accepts the quest from the village elder and prepares to enter the goblin lair.",
            scene: { parts: [] },
            notes: []
        }
    ],
